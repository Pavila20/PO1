...
const tutorialData = [
  {
    ...
    desc: "Please wet your filter cup to a minimal amount before starting the grinder",
    image: require("../assets/images/Before-continuing.png"),
  },
  {
    id: "1",
    title: "Step 1: Place Filter Cup",
    desc: "Place the wet filter cup under the grinder dispenser",
    image: require("../assets/images/Step-1-Place-filter-Cup.png"),
  },
  {
    id: "2",
    title: "Step 2: Move Filtered Cup",
    desc: "Once the extraction is complete, carefully move the filtered cup to the water dispensing area.",
  ...
  {
    id: "4",
    title: "Step 4: Enjoy Your Coffee!",
    desc: "Your perfect cup of coffee is ready. Sip, relax, and enjoy the moment.",
    image: require("../assets/images/Step-3-Enjoy-your-coffee.png"),
  },
];
